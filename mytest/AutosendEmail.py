...
#
#         if filename is not None and file_type=='Q3':
#             num = 0
#             lines_num = 0
...
#                         num1 +=1
#                 # if str3 in line:
#                 #     path_list[i].append('the log has disconnect')
#                 #     filename_dic[str(path_list[i])] = filename
#                 #     break
#             if num1>1:
#                 path_list[i].append(num)
#                 filename_dic[str(path_list[i])] = filename
#             elif num1==1 and num-num1>0:
#                 path_list[i].append(num)
#                 filename_dic[str(path_list[i])] = filename
#             else:
#                 filename_dic[str(path_list[i])] = 'discontent'
