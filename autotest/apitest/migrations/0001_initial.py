    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apitestname', models.CharField(max_length=60, verbose_name='流程接口名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apimethod', models.CharField(choices=[('get', 'get'), ('post', 'post'), ('put', 'put'), ('delete', 'delete'), ('patch', 'patch')], default='get', max_length=200, null=True, verbose_name='请求方式')),
